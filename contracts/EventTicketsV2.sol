...
contract EventTicketsV2 {
    ...
    */
    function addEvent(string memory description, string memory url, uint ticketAmount) public verifyOwner returns (uint) {
    ...
    /*
        ...
        The function returns information about the event this order:
            ...
            5. isOpen
    */
    function readEvent(uint eventId) public view returns (string memory description, string memory url, uint ticketsAvailable, uint sales, bool isOpen) {
    ...
    */
    function buyTickets(uint eventId, uint ticketsToPurchase) payable public {
        require(events[eventId].isOpen);
        require(msg.value >= PRICE_TICKET * ticketsToPurchase);
        require(events[eventId].totalTickets >= ticketsToPurchase);
        ...
        uint change = msg.value - (PRICE_TICKET * ticketsToPurchase);
    ...
    */
    function getRefund(uint eventId) public {
        ...
        msg.sender.transfer(PRICE_TICKET * ticketsToRefund);
